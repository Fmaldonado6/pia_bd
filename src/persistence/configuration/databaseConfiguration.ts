...
class DatabaseConfiguration {
    ...
    async createTables() {
        ...
        await database.executeQuery(`IF OBJECT_ID('Pais','U') IS NULL CREATE TABLE Pais(
        ...
        await database.executeQuery(`IF OBJECT_ID('Estado','U') IS NULL CREATE TABLE Estado(
        ...
        await database.executeQuery(`IF OBJECT_ID('Municipio','U') IS NULL CREATE TABLE Municipio(
        ...
        await database.executeQuery(`IF OBJECT_ID('Colonia','U') IS NULL CREATE TABLE Colonia(
        ...
        await database.executeQuery(`IF OBJECT_ID('Calle','U') IS NULL CREATE TABLE Calle(
        ...
        await database.executeQuery(`if object_id('Privilegios','U') is null create table Privilegios(
            idPrivilegio int not null IDENTITY(1,1),
            constraint pkPrivilegio primary key (idPrivilegio),
            nombre varchar(200),
        )`)

        await database.executeQuery(`if object_id('TipoEmpleado','U') is null create table TipoEmpleado(
        ...
        await database.executeQuery(`if object_id('EmpPrivilegios','U') is null create table EmpPrivilegios(
        ...
        await database.executeQuery(`if object_id('Empleado','U') is null create table Empleado(
            nombre varchar(200) not null,
            telefono int,
        ...
        await database.executeQuery(`if object_id('Marca','U') is null create table Marca(
        ...
        await database.executeQuery(`if object_id('Alimentos','U') is null create table Alimentos(
        ...
        await database.executeQuery(`if object_id('Pedidos','U') is null create table Pedidos(
        ...
        await database.executeQuery(`if object_id('PedidosAlimentos','U') is null create table PedidosAlimentos(
